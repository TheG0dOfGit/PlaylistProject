...
public class PlaylistTester
{
    ...
    public static void main(String[] args)
    {
        ...
        Song Seventeen = new Song ("Seventeen", "4:05", "Winger",true);
        Lads.add(Seventeen);
        System.out.println("Added 'Seventeen' by Winger (4:05)");
        Song Women = new Song ("Women", "5:41", "Def Leppard", true);
        System.out.println("Added 'Women' by Def Leppard (5:41)");
        Lads.add(Women);
        Song Summer69 = new Song("Summer of '69", "3:36", "Bryan Adams", true);
        Lads.add(Summer69);
        System.out.println("Added 'Summer of '69' by Bryan Adams (3:36)");
        Song DogBone = new Song("Givin' the Dog a Bone", "3:30", "AC/DC", true);
        Lads.add(DogBone);
        System.out.println("Added 'Givin' the Dog a Bone' by AC/DC (3:30)");
        Song Panama = new Song("Panama", "3:31", "Van Halen", true);
        Lads.add(Panama);
        System.out.println("Added 'Panama' by Van Halen (3:31)");
        Song WalkThisWay = new Song("Walk This Way", "3:40", "Aerosmith", true);
